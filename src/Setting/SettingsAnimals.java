...
public class SettingsAnimals {
    ...
    public static final double ACTUAL_SATIETY_WOLF = 8/2;
    ...
    public static final double ACTUAL_SATIETY_BOA = 3/2;
    ...
    public static final double ACTUAL_SATIETY_FOX = 2/2;
    ...
    public static final double ACTUAL_SATIETY_EAGLE = 1/2;
    ...
    public static final double ACTUAL_SATIETY_BEAR = 60/2;
    ...
    public static final double ACTUAL_SATIETY_SHEEP = 15/2;
    ...
    public static final double ACTUAL_SATIETY_BOAR = 50/2;
    ...
    public static final double ACTUAL_SATIETY_BUFFALO = 100/2;
    ...
    public static final double ACTUAL_SATIETY_DEER = 60/2;
    ...
    public static final double ACTUAL_SATIETY_DUCK = 0.15/2;
    ...
    public static final double ACTUAL_SATIETY_GOAT = 10/2;
    ...
    public static final double ACTUAL_SATIETY_HORSE = 60/2;
    ...
    public static final double ACTUAL_SATIETY_MOUSE = 0.15/2;
    ...
    public static final double ACTUAL_SATIETY_RABBIT = 0.45/2;
